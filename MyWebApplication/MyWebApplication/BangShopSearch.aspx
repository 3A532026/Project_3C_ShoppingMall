<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BangShopSearch.aspx.cs" Inherits="MyWebApplication.BangShopSearch" %>
                                                  ...
                                                  <!--  <img src="data:image/png;base64,% =product.getImage() %>" style="height:300px; width:270px;" alt="沒圖片啦" />  
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <ul class="action-button">
                                                            <li class="zmdi zmdi-shopping-cart-plus">
                             ...
                             <!-- SearchButton --> 
                                ...
                                <form action="#">
                                  ...
                                  <button type="submit" id="SearchButton" onclick="Search()"><i class="zmdi zmdi-search"></i></button> 
                                   ...
                                   <input type="text" id="SearchK" placeholder="Search here..." /> 
                                    <script>
                                        function Search()
                                        {
                                            var Str = document.getElementById("SearchK").value;
