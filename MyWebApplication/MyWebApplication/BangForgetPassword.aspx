<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BangForgetPassword.aspx.cs" Inherits="BangForgetPassword" %>
       ...
       <!-- START HEADER AREA -->
        ...
        <!-- END HEADER AREA -->
                        ...
                        <div class="col-md-8 col-md-offset-2" style="text-align:center; position:center;">
                                    <p><strong style="font-size: xx-large">忘 記 密 碼</strong></p>
                                    <div class="login-account p-30 box-shadow" style="position:center;" >
                                        <div class="row" style="position:center">

                                            <div class="col-sd-2">
                                            <input type="text" name="Account"  placeholder="您的帳號"/>
                                            </div>
