<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BangChangePassword.aspx.cs" Inherits="BangChangePassword" %>
       ...
       <!-- START HEADER AREA -->
        ...
        <!-- END HEADER AREA -->
                        ...
                        <div class="col-md-8 col-md-offset-2" style="text-align:center; position:center;">
                                    <p><strong style="font-size: xx-large">更 改 密 碼</strong></p>
                                    <div class="login-account p-30 box-shadow" style="position:center;" >
                                        <div class="row" style="position:center">

                                            <div class="col-sd-2">
                                            <input type="text" name="UserID"  placeholder="輸入您的帳號"/>
                                            </div>

                                            <div class="col-sd-2">
                                            <input type="password" name="NewPassword"  placeholder="輸入新的密碼"/>
                                            </div>
                                ...
                                <center>
                                    <asp:Button CssClass="submit-btn-1" ID="Submit" runat="server" Text="送出" OnClick="Submit_Click" />                                   
                                </center>
                              </div>     
