<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BangShopSearchByCategory.aspx.cs" Inherits="MyWebApplication.BangShopSearchByCategory" %>
                                            ...
                                            <div class="col-md-12">
                                                <div class="shop-list product-item">
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <h3 class="pro-price" style="color:red">
                                                            <asp:Label ID="Label2" runat="server" Text="$"></asp:Label> <%= product.getPrice() %></h3>
